...
/** Inline-only highlight for the composer mirror (no padding — keeps lines aligned). */
export const MENTION_COMPOSER_CLASS = "font-semibold text-blue-700 dark:text-blue-300"
